...
func _ready():
	...
	if GlobalVariables.player_name == null:
		...
		if GlobalVariables.entry_2[0] == "":
			GlobalVariables.entry_2 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_3[0] == "":
			GlobalVariables.entry_3 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_4[0] == "":
			GlobalVariables.entry_4 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_5[0] == "":
			GlobalVariables.entry_5 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_6[0] == "":
			GlobalVariables.entry_6 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_7[0] == "":
			GlobalVariables.entry_7 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_8[0] == "":
			GlobalVariables.entry_8 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_9[0] == "":
			GlobalVariables.entry_9 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		elif GlobalVariables.entry_10[0] == "":
			GlobalVariables.entry_10 = [GlobalVariables.player_name, time_string, GlobalVariables.player_score]
		else:
			pass
	load_entries()
